  ...
  return (
    <AuroraHero>
      <div className="mx-auto flex max-w-5xl flex-col items-center px-6 text-center">
        ...
        >
          Digitale oplossingen die helder voelen vanaf het eerste scherm.
        </motion.h1>
        ...
        >
          Van website tot app, van idee tot lancering. Vancoillie Studio maakt
          digitale producten die structuur, snelheid en gebruiksgemak
          samenbrengen.
        </motion.p>
