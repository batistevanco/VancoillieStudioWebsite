      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="flex flex-col items-start gap-4 py-6 lg:py-10">
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-3xl font-semibold tracking-tighter text-white md:text-5xl lg:max-w-xl">
              {title}
            </h2>
            <p className="max-w-xl text-lg leading-relaxed tracking-tight text-white/60">
              {description}
            </p>
          </div>
            ...
            <div className="grid items-start gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-3">
              {items.map((item) => (
                <div key={item.title} className="flex w-full flex-row items-start gap-6">
                  <Check className="mt-2 h-4 w-4 shrink-0 text-white/70" />
