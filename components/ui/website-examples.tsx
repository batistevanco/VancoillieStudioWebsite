  ...
  return (
    <section className="bg-white py-20 md:py-28">
      ...
      <div className="flex items-end justify-between px-8 md:px-20 mb-10">
        ...
        <button
          onClick={scrollRight}
          className="hidden md:flex flex-none items-center gap-2 rounded-full border border-neutral-200 px-5 py-3 text-sm font-medium text-neutral-600 hover:bg-neutral-50 hover:border-neutral-300 transition-colors"
        >
          Scroll verder
      ...
      >
        {EXAMPLES.map(({ title, src, href }) => (
          <a
            ...
            className="group relative flex-none w-[80vw] md:w-[55vw] lg:w-[45vw] snap-start shrink-0 overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-50 shadow-sm hover:shadow-lg transition-shadow duration-300"
